...
## 2. 计算设计方案
- 分子结构（SMILES）：`CC1=C(C(C(=C(N1)C)C(=O)OCCCN2CCC(CC2)(C3=CC=CC=C3)C4=CC=CC=C4)C5=CC(=CC=C5)[N+](=O)[O-])C(=O)OC`（另见 YeastBridge_Mol002_ligand.smi / _ligand_pose.sdf）
- 小分子-靶点复合物结构预测文件：YeastBridge_Mol002_complex.pdb（蛋白取自 O95069 实验结构的清洁聚合物链；配体为 Vina-GPU 最优口袋 pose）
